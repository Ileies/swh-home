<section class="py-16 mt-12">
	<div class="container mx-auto px-4">
		<div class="max-w-3xl mx-auto">
			<h1 class="text-2xl font-semibold mb-8">Impressum</h1>

			<div class="space-y-8">
				<div>
					<h2 class="text-xl font-semibold mb-4">Angaben gemäß § 5 TMG</h2>
					<p>
						Smartworkhub GmbH<br />
						[Straße Nr.]<br />
						[PLZ Ort]<br />
						Deutschland
					</p>
				...
				<div>
					...
					<p>
						...
						E-Mail: contact@smartworkhub.com
					</p>
				</div>
				...
				<div>
					<h2 class="text-xl font-semibold mb-4">Inhaltlich Verantwortlicher</h2>
					<p>
				...
				<div>
					<h2 class="text-xl font-semibold mb-4">Urheberrecht</h2>
					<p>
